...
void push(char *, char [1000][1000], int);
int is_last(char *, char [1000][1000], int);
...
void push(char *t, char d[1000][1000], int index)
{
  strcpy(d[index], t);

}

int is_last(char *t, char d[1000][1000], int index)
{
